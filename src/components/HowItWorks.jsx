      ...
      <div className="container">
        ...
        <div className="steps">
          <div className="step">
            ...
            <p>
              Sign up for a FREE account and specify the areas and times your parking lot is available for eAV Robotaxi use.
            </p>
          </div>
          <div className="step">
        ...
        <div className="centered-button">
          <button className="sign-up-button" onClick={handleSignUpClick}>Sign Up Today!</button>
        </div>
      </div>
    </section>
  );
